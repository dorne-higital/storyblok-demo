...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-D-fp-k7O.mjs').then((m2) => m2.default || m2)
  }
];
...
const LazyFeature = defineAsyncComponent(() => import('./Feature-tRGk_CQI.mjs').then((r) => r.default));
const LazyGrid = defineAsyncComponent(() => import('./Grid-BfP1yYiX.mjs').then((r) => r.default));
const LazyPage = defineAsyncComponent(() => import('./Page-Bty_3pFI.mjs').then((r) => r.default));
const LazyTeaser = defineAsyncComponent(() => import('./Teaser-CU1NNxVO.mjs').then((r) => r.default));
...
const Pe = () => (y || E("useStoryblokApi"), y), Ie = {
  install(i, e = {}) {
    i.directive("editable", Se), i.component("StoryblokComponent", Te), e.enableFallbackComponent && !e.customFallbackComponent && i.component(
      "FallbackComponent",
      defineAsyncComponent(() => import('./FallbackComponent-hOszcW1L-Bkr58ody.mjs'))
    );
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-jg1rrRm8.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-B5NlqPTd.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-DDLplZlz.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { Pe as P, _export_sfc as _, useRuntimeConfig as a, navigateTo as b, createError as c, useNuxtApp as d, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
