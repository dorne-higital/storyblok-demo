...
var H = (i) => new Promise((e, t) => {
  ...
  s.async = true, s.src = i, s.id = "storyblok-javascript-bridge", s.onerror = (r) => t(r), s.onload = (r) => {
    x.forEach((o) => o()), j = true, e(r);
  }, document.getElementsByTagName("head")[0].appendChild(s);
});
var q = Object.defineProperty;
var V = (i, e, t) => e in i ? q(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var h = (i, e, t) => (V(i, typeof e != "symbol" ? e + "" : e, t), t);
function C(i) {
...
var _e = (i) => !i || !(i != null && i.content.some((e) => e.content || e.type === "blok" || e.type === "horizontal_rule"));
var Ce = (i, e, t) => {
  let s = t || T;
  if (!s) {
    console.error(
...
var Ie = {
  install(i, e = {}) {
    i.directive("editable", Se), i.component("StoryblokComponent", Te), e.enableFallbackComponent && !e.customFallbackComponent && i.component(
      "FallbackComponent",
      defineAsyncComponent(() => import("./FallbackComponent-hOszcW1L-AORME35O.js"))
    );
